...
export default function AddNewIngredient({
  ...
  const [newIngredientName, setNewIngredientName] = useState<string>(initialName);
  const [newIngredientImage, setNewIngredientImage] = useState<File | undefined>();
  const [newIngredientImageUrlObj, setNewIngredientImageUrlObj] = useState<string | undefined>();
  ...
  const saveIngredient = async (event: React.MouseEvent<HTMLButtonElement>) => {
