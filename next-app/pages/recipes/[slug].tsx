...
import { isAdmin, getCanonicalEmail } from '@/utils/auth';
...
export const getServerSideProps: GetServerSideProps<RecipePageProps> = async (context) => {
  ...
  const instructionsHtml = processedContent.toString();
...
export default function Recipe({ recipe, sliderState, ingredientState, isAdmin }: RecipePageProps) {
